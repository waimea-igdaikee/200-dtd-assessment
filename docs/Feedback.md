...
> The end user section should be details of the specific requirements / needs that the end user has - see the exemplar. You have listed the system features

> Key functionality - should be a list of all features you think the system should have (see exemplar)
